 ...
 * prices are sourced per-item where available; priceRange values ending in "(추정)"
 * did not have a confirmed price in any source and use a category-typical estimate.
 *
...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        restaurantRepository.saveAll(List.of(
                ...
                new Restaurant("써브웨이 부산동아대점", "패스트푸드 / 샌드위치", "세트 7,500원~ (추정)", 7500,
                        5, 1, LocationZone.SHUTTLE_STOP, 4,
                        "15cm 샌드위치 세트",
                        "https://map.kakao.com/?q=써브웨이 부산동아대점 부산 사하구 낙동대로 542",
                        List.of("빠른 서비스", "평지 접근")),

                new Restaurant("온센 부산사하구점", "일식 / 텐동·튀김덮밥", "8,900 ~ 10,900원", 9500,
                        12, 1, LocationZone.MAIN_GATE, 4,
                        "온센텐동",
                        "https://map.kakao.com/?q=온센 부산사하구점 부산 사하구 낙동대로516번길 43",
                        List.of("가성비", "평지 접근")),

                new Restaurant("다맛", "한식 / 경양식 돈까스", "8,500 ~ 9,000원", 8500,
                        15, 1, LocationZone.MAIN_GATE, 4,
                        "등심돈까스 (식전 스프 포함)",
                ...
                new Restaurant("올바로갈비", "한식 / 돼지갈비", "생돼지갈비 100g 3,900원~", 12000,
                        20, 1, LocationZone.SHUTTLE_STOP, 10,
                        "생돼지갈비 / 양념돼지갈비",
                        "https://map.kakao.com/?q=올바로갈비 부산 사하구 낙동대로519번길 25",
                        List.of("특별한 한 끼", "평지 접근")),

                new Restaurant("짜가후라이드치킨", "치킨 / 후라이드", "후라이드 한마리 약 18,000원 (추정)", 18000,
                ...
                new Restaurant("하이뽕 동아대점", "중식 / 퓨전짬뽕", "9,000원~ (추정)", 9000,
                        15, 1, LocationZone.MAIN_GATE, 6,
                        "크림뽕 / 로제뽕",
                        "https://map.kakao.com/?q=하이뽕 동아대점 부산 사하구 낙동대로516번길 16",
                        List.of("가성비")),

                new Restaurant("삼국지짬뽕천하", "중식 / 짬뽕·탕수육", "탕수육 세트 19,500 ~ 21,500원", 13000,
                        15, 1, LocationZone.MAIN_GATE, 2,
                        "차돌짬뽕 + 탕수육 세트",
