...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        restaurantRepository.saveAll(List.of(
                ...
                new Restaurant("맘스터치 동아대점", "패스트푸드 / 버거", "싸이버거 세트 7,300원", 7300,
                ...
                new Restaurant("돌담식당", "한식 / 백반·찌개", "5,000 ~ 8,000원", 7000,
                        12, 1, LocationZone.MAIN_GATE, 4,
                        "김치찌개 (찌개·비빔밥·볶음밥류 다양)",
                        "https://map.kakao.com/?q=돌담식당 부산 사하구 낙동대로550번길 16-1",
                        List.of("가성비", "평지 접근")),

                new Restaurant("롯데리아·맥도날드 동아대점", "패스트푸드 / 버거", "세트 7,300 ~ 7,600원", 7300,
                        6, 1, LocationZone.SHUTTLE_STOP, 2,
                        "불고기버거 세트 / 빅맥 세트",
                        "https://map.kakao.com/?q=맥도날드 동아대점 부산 사하구 낙동대로 548",
                        List.of("빠른 서비스", "가성비", "평지 접근")),

                new Restaurant("써브웨이 부산동아대점", "패스트푸드 / 샌드위치", "에그마요 15cm세트 10,900원 (매장 메뉴판 확인)", 10900,
                        5, 1, LocationZone.SHUTTLE_STOP, 4,
                        "15cm 샌드위치 세트",
                        "https://map.kakao.com/?q=써브웨이 부산동아대점 부산 사하구 낙동대로 542",
                        List.of("빠른 서비스", "평지 접근")),

                new Restaurant("온센 부산사하구점", "일식 / 텐동·튀김덮밥", "온센텐동 9,500원 (매장 메뉴판 확인)", 9500,
                        12, 1, LocationZone.MAIN_GATE, 4,
                        "온센텐동",
                ...
                new Restaurant("핏제리아곳간", "양식 / 화덕피자·파스타", "알리오올리오 11,900원 / 트러플크림뇨끼 15,500원 (매장 메뉴판 확인)", 11900,
                        15, 1, LocationZone.SHUTTLE_STOP, 4,
                        "마르게리따 피자",
                        "https://map.kakao.com/?q=핏제리아곳간 부산 사하구 낙동대로 543",
                        List.of("가성비")),

                new Restaurant("명륜진사갈비 부산하단점", "한식 / 돼지갈비 무한리필", "1인 13,500원 (무한리필 정상가)", 13500,
                        20, 1, LocationZone.SHUTTLE_STOP, 5,
                        "무한리필 돼지갈비",
                        "https://map.kakao.com/?q=명륜진사갈비 부산하단점 부산 사하구 낙동대로 533",
                        List.of("특별한 한 끼", "단체모임 추천")),

                new Restaurant("신전떡볶이 동아대점", "분식 / 떡볶이", "오리지널 떡볶이 4,500원 (1인 세트 9,500원)", 4500,
                ...
                new Restaurant("삼국지짬뽕천하", "중식 / 짬뽕·탕수육", "산동탕수육(미니) 13,000원 / 탕수육 세트 19,500 ~ 21,500원", 13000,
                        15, 1, LocationZone.MAIN_GATE, 2,
                        "차돌짬뽕 + 탕수육 세트",
